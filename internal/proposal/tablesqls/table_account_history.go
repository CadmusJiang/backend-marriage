...
func CreateAccountHistoryTableDataSql() (sql string) {
	...
	sql += "(2, 'created', '2024-01-10 10:00:00', '{\"username\": {\"old\": \"\", \"new\": \"employee001\"}, \"name\": {\"old\": \"\", \"new\": \"张三\"}, \"roleType\": {\"old\": \"\", \"new\": \"员工\"}, \"phone\": {\"old\": \"\", \"new\": \"13800138000\"}, \"belongGroup\": {\"old\": \"\", \"new\": \"南京-天元大厦组\"}, \"belongTeam\": {\"old\": \"\", \"new\": \"营销团队A\"}}', 'admin', '系统管理员', 'company_admin', '系统管理员', '系统管理员');"
