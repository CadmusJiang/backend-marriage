...
func CreateAccountTableSql() (sql string) {
	...
	sql += "`last_login_at` bigint DEFAULT NULL COMMENT '最后登录时间戳',"
...
func CreateAccountTableDataSql() (sql string) {
	sql = "INSERT INTO `account` (`username`, `nickname`, `password`, `phone`, `role_type`, `status`, `belong_group_id`, `belong_team_id`, `last_login_at`, `created_at`, `updated_at`, `created_user`, `updated_user`) VALUES"
	...
	sql += "('team_manager2', '赵敏', 'e10adc3949ba59abbe56e057f20f883e', '13800138005', 'team_manager', 'disabled', 3, 7, 1705123200, 1705123200, 1705123200, '系统管理员', '系统管理员'),"
	...
	sql += "('employee003', '周杰', 'e10adc3949ba59abbe56e057f20f883e', '13800138008', 'employee', 'enabled', 3, 7, 1705123200, 1705123200, 1705123200, '系统管理员', '系统管理员'),"
