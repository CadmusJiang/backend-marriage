...
func CreateCooperationStoreHistoryTableDataSql() (sql string) {
	sql = "INSERT INTO `cooperation_store_history` (`store_id`, `operate_type`, `operated_at`, `content`, `operator_username`, `operator_role_type`, `created_at`, `updated_at`, `created_user`, `updated_user`) VALUES"
	sql += "(1, 'created', '2024-01-13 10:00:00', '{\"store_name\":\"上海婚恋门店1\",\"cooperation_city_code\":\"310000\"}', 'admin', 'company_manager', '2024-01-13 10:00:00', '2024-01-13 10:00:00', '系统管理员', '系统管理员'),"
	sql += "(2, 'created', '2024-01-14 10:00:00', '{\"store_name\":\"北京婚恋门店2\",\"cooperation_city_code\":\"110000\"}', 'admin', 'company_manager', '2024-01-14 10:00:00', '2024-01-14 10:00:00', '系统管理员', '系统管理员'),"
	sql += "(3, 'created', '2024-01-15 10:00:00', '{\"store_name\":\"深圳婚恋门店3\",\"cooperation_city_code\":\"440300\"}', 'admin', 'company_manager', '2024-01-15 10:00:00', '2024-01-15 10:00:00', '系统管理员', '系统管理员');"
	return
}
